					...
					<div class="container-fluid">
						...
						<div class="card">
							<div class="register-card-body">
								<form role="form" name="frm" class="form-horizontal" method="post" action="${cp }/member/modifyUser" enctype="multipart/form-data" onSubmit="return Checkform()">
									<input type="hidden" name="userid" value="${user.userid }"/>
									<div class="input-group mb-3">
										<div class="mailbox-attachments clearfix" style="text-align: center; width:100%;">
											<div class="mailbox-attachment-icon has-img"  style="border: 1px solid green; height: 200px; width: 140px; margin: 0 auto;">
												<img src="${cp}/member/profile?userid=${user.userid }" id="pictureViewImg" style="width:100%; height:100%;"/>
											</div>
											<div class="mailbox-attachment-info">
												<div class="input-group input-group-sm">
													<input id="picture" class="form-control" type="file" name="profile" accept=".gif, .jpg, .png" style="height:37px;"/>
												</div>
											</div>
										</div>
										<br />
									...
									<div class="form-group row">
										...
										<div class="col-sm-9 input-group-sm">
											<input class="form-control" name="pass" type="password" value="${user.pass }" class="form-control" id="pass" placeholder="비밀번호" />
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-9 input-group-sm">
											<input class="form-control" name="usernm" type="text" value="${user.usernm }" id="usernm" placeholder="이름" />
										</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-9 input-group-sm">
											<input class="form-control" name="alias" type="text" value="${user.alias }" id="alias" placeholder="별명">
										</div>
									</div>
									<div class="form-group row">
										<label for="addr1" class="col-sm-3 control-label">주소</label>
										<div class="col-sm-3 input-group-sm">
											<input name="addr1" type="text" class="form-control" id="addr1" value="${user.addr1 }" placeholder="주소" readonly>
										</div>
										<div class="col-sm-3 input-group-sm">
											<input name="addr2" type="text" class="form-control" id="addr2" value="${user.addr2 }" placeholder="상세주소">	
										</div>
										
										<div class="col-sm-2 input-group-sm">
											<input name="zipcode" type="text" class="form-control" id="zipcode" value="${user.zipcode }" placeholder="우편번호" readonly>
										</div>
									...
									<div class="card-footer">
										<div class="row">
											...
											<div class="col-sm-6">
												<button type="button" id="cancelBtn" onclick="location.href='${cp }/user?userid=${user.userid }'" class="btn btn-default float-right">&nbsp;&nbsp;&nbsp;취 &nbsp;&nbsp;소&nbsp;&nbsp;&nbsp;</button>
											</div>
